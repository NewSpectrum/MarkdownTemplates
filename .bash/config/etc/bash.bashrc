...
PROMPT_DIRTRIM=2
PS1="\e[1;38;5;75m\]\n[\e[0m\] \e[38;5;51m\]\u \e[1;38;5;75m\]|\e[0m\] \e[38;5;51m\]\h \e[1;38;5;75m\]]\e[0m\]\n \e[38;5;154m\]\W\e[93m\]\n \$ \e[0m\]"
...
if [[ "${PATH}" != *"/usr/local/dotnet/current"* ]]; then export PATH=/usr/local/dotnet/current:${PATH}; fi
...
alias lsd="sudo ls -a -l -h -F -B --group-directories-first --color=always"
alias gimme="sudo chmod -v -R a+rwx"